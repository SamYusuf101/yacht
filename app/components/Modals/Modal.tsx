...
const Modal: React.FC<ModalProps> = ({
  ...
  overflow-x-hidden overflow-y-auto px-4 fixed inset-0
  z-50 outline-none focus:outline-none bg-neutral-800/70"
    >
      ...
      >
        ...
        ${showModal ? "translate-y-0" : "tarnslate-y-full"}
        ${showModal ? "opacity-100" : "opacity-0"}
        
        `}
        >
          <div
            className="translate top-80 mt-10 md:mt-0 md:top-0 lg:h-auto md:h-auto border-0
          ...
          >
            ...
            >
              <button
                onClick={handleClose}
                className="p-1 border-0 hover:opacity-70 transition absolute left-7"
              >
                <IoMdClose size={18} />
              </button>
              <div>{title}</div>
